...
static void lcd_preheat_all_menu();
static void lcd_preheat_nozzle0_menu();
static void lcd_preheat_nozzle1_menu();
static void lcd_preheat_hb_menu();
...
void lcd_preheat_nylon_hb()
{
    setTargetBed(NYLON_PREHEAT_HPB_TEMP);
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
}

void lcd_preheat_pva1_hb()
{
    setTargetBed(PVA_PREHEAT_HPB_TEMP);
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
}

void lcd_preheat_laywood_hb()
{
    setTargetBed(ABS_PREHEAT_HPB_TEMP);
    lcd_return_to_status();
    setWatch(); // heater sanity check timer
...
static void lcd_preheat_menu()
{
    ...
    MENU_ITEM(submenu, MSG_ALL, lcd_preheat_all_menu);
    MENU_ITEM(submenu, MSG_NOZZLE_0, lcd_preheat_nozzle0_menu);
    MENU_ITEM(submenu, MSG_NOZZLE_1, lcd_preheat_nozzle1_menu);
    MENU_ITEM(submenu, MSG_HOT_BED, lcd_preheat_hb_menu);
    END_MENU();
}
...
{
    START_MENU();
    MENU_ITEM(back, MSG_PREHEAT, lcd_preheat_menu);
...
static void lcd_preheat_nozzle0_menu()
{
    ...
    MENU_ITEM(function, MSG_PREHEAT_NYLON, lcd_preheat_nylon0);
...
static void lcd_preheat_nozzle1_menu()
{
    ...
    MENU_ITEM(function, MSG_PREHEAT_NYLON, lcd_preheat_nylon1);
...
static void lcd_preheat_hb_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_PREHEAT, lcd_preheat_menu);
    MENU_ITEM(function, MSG_PREHEAT_PLA, lcd_preheat_pla_hb);
    MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs_hb);
    MENU_ITEM(function, MSG_PREHEAT_NYLON, lcd_preheat_nylon_hb);
